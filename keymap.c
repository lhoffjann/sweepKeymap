...
//
    KC_A,   KC_R,   MT(MOD_LALT, KC_S),    MT(MOD_LGUI,KC_T), KC_G,             KC_M,    MT(MOD_RGUI,KC_N),  MT(MOD_RALT,KC_E),    LT(9,KC_I),   KC_O,
//
...
//
    KC_NO,   G(KC_1),   G(KC_2), G(KC_3), KC_NO,                                        KC_F1,    KC_F2,  KC_F3, KC_F4, TO(3),
//
            TO(0),   OSM(MOD_LSFT),             OSM(MOD_RCTL), TO(2)
  ),
